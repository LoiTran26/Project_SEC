...
#define LENGTH_SENSOR_ASKTYPE 2 /*CheckFame 2*/
#define LENGTH_SENSOR_ANSWERTYPE 3 /*Data[0] = TypeSensor 1 + CheckFame 2*/
#define LENGTH_SENSOR_ASKDATA 2 /*CheckFame 2*/
#define LENGTH_SENSOR_ANSWERDATA 3 /*Data[0] = TypeSensor 1 + CheckFame 2*/

#define LENGTH_SENSOR_1_DATA 4
#define LENGTH_SENSOR_2_DATA 4
#define LENGTH_SENSOR_3_DATA 4
#define LENGTH_SENSOR_4_DATA 4
#define LENGTH_SENSOR_5_DATA 4
#define LENGTH_SENSOR_6_DATA 4
...
/* chuyen doi data cua cac sensor */
